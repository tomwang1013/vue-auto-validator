...
var emailValidFormat = /^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/;
...
module.exports = {
  ...
  email: function(field) {
    ...
    if (!val) return true;
    else emailValidFormat.test(val);
  },

  equalTo: function(field, otherFieldName) {
    var val = getFieldValue(field);
    var otherFieldValue = getFieldValue(field.form[otherFieldName]);
